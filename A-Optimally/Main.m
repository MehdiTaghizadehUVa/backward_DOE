...
%--------------------------------------------------------------------------
load('3D-12O-Ishigami-Result-A.mat')
...
[Error_y_F, Error_cf_F, Time_F, Criteria_F] = PaperMethod_AO(Y, A, NumberofSelection, Subset_Size, n_simulation, A_test, Y_test, C_real);
%Our Method
Subset_Size = 30;
[Error_y_B, Error_cf_B, Time_B, Criteria_B] = OptimalPointSelection_AO(Y, A, NumberofSelection, Subset_Size, n_simulation, A_test, Y_test, C_real);
% Error_y_MC = MonteCarlo_Slow(dim, order, NumberofSelection, n_simulation);

save('3D-12O-Ishigami-Result-A.mat')
exit