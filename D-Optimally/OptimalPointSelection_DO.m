function [Error_y_B, Error_cf_B, Time_B, Criteria_B]  = OptimalPointSelection_DO(Y, A, NumberofSelection, Subset_Size, n_simulation, A_test, Y_test, C_real)
% number of coeffient
