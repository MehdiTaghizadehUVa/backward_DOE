...
[Error_y_F, Error_cf_F, Time_F, Criteria_F] = PaperMethod_DO(Y, A, NumberofSelection, Subset_Size, n_simulation, A_test, Y_test, C_real);
%Our Method
Subset_Size = 30;
[Error_y_B, Error_cf_B, Time_B, Criteria_B] = OptimalPointSelection_DO(Y, A, NumberofSelection, Subset_Size, n_simulation, A_test, Y_test, C_real);

save('3D-12O-Ishigami-Result-D.mat')
exit